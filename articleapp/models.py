...
class ArticleCreateModel(models.Model):
    article = models.ForeignKey(User, on_delete=models.CASCADE, related_name='article')
    article_project = models.ForeignKey(ProjectCreateModel, on_delete=models.CASCADE, related_name='article_project')
